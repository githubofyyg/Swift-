 ...
 * The maximum length of time to keep an image in the cache, in seconds
                图片的缓存时长(超过这个时间就没有了(> <)   ) in seconds为秒
 ...
 * The maximum size of the cache, in bytes.
       ...
       --. 缓存大小  也就是说最多装多少,超过会清除之前的数据 (单位为字节)
 */
...
/**
 * Clear all disk cached images 所有的,内存(沙盒里)的所有图片都清除掉,(所有,)
...
/**
 * Remove all expired cached image from disk 清除过期的缓存!!!!!注意是过期的
