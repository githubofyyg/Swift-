...
//        self.window?.rootViewController = testVC
        self.createTabBarView()
         AVOSCloud.setApplicationId("6fwS1d4UYHzqSezyjzIkSaOU-gzGzoHsz", clientKey: "Q0ppabSvhS54IDT6Fqx9i5XC")
    ...
    func createTabBarView() {
        ...
        let serviceNC = UINavigationController(rootViewController: serviceVC)
        serviceVC.title = "商品"
        ...
        let myNaviVC = UINavigationController(rootViewController: myVC)
        
        myVC.title = "我的"
        
        let tabVC = UITabBarController()
        
        tabVC.viewControllers = [serviceNC, chatNC, myNaviVC]
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("ServiceShop", withExtension: "momd")!
